...
import {BodyLong, BodyShort, Ingress, Link, Title} from "@navikt/ds-react";
...
const Oppsigelse: NextPage = () => {
  ...
  <Title spacing={true} size={'l'}>Oppsigelse</Title>
    ...
    <BodyShort>Samhandling med NAV</BodyShort>
    <BodyLong spacing = {true}>
    ...
    <BodyShort>Bistand til berørte arbeidstakere</BodyShort>
    <BodyLong spacing = {true}>
    ...
    <BodyShort>Varsel til de ansatte</BodyShort>
    <BodyLong spacing = {true}>
    ...
    <BodyShort>I tillegg ber vi deg som arbeidsgiver oppgi følgende i varselet:</BodyShort>
    <BodyLong spacing = {true}>
    ...
    <BodyShort>Dokumentert enighet</BodyShort>
    <BodyLong spacing = {true}>
