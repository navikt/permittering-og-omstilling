...
import { BodyLong, BodyShort, Header, Ingress, Panel, Title } from "@navikt/ds-react"
  ...
  return (
    <div>
      ...
      <div className={styles.omstilling}>
        <Container>
          <Title spacing size={"s"}>Hva kan NAV bistå med i en omstillingssituasjon?</Title>
          <BodyLong>
        ...
        <Title spacing size={"s"}>Registrere seg som arbeidssøker</Title>
        <BodyLong spacing>
        ...
        <Title spacing size={"s"}>Jobbe i utlandet?</Title>
        <BodyShort spacing>
