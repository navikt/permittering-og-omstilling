...
import { AssetFromSource, AssetSource, File as BaseFile, FileAsset, FileSchemaType, Marker, Path, SchemaType } from '@sanity/types';
...
export default class FileInput extends React.PureComponent<Props, FileInputState> {
    ...
    handleFieldChange: (event: PatchEvent, field: Field) => void;
